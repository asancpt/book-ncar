...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{left_join}\NormalTok{(}\KeywordTok{as_tibble}\NormalTok{(Theoph_nca) }\OperatorTok{%>%}\StringTok{ }
...
\ExtensionTok{Date}\NormalTok{ and Time: 2019-11-06 12:27:39 Asia/Seoul}
...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2019-11-06} \DecValTok{12}\OperatorTok{:}\DecValTok{27}\OperatorTok{:}\DecValTok{39}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
