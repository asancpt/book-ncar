...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2018-07-04} \DecValTok{09}\OperatorTok{:}\DecValTok{07}\OperatorTok{:}\DecValTok{33}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
