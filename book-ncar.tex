...
\tightlist
\item
  NonCompart (Bae \protect\hyperlink{ref-R-NonCompart}{2018})
\item
  pkr (Bae and Lee \protect\hyperlink{ref-R-pkr}{2017})
\item
  ncar (Bae \protect\hyperlink{ref-R-ncar}{2017})
\end{itemize}
...
\protect\hyperlink{ref-R-NonCompart}{2018}), \texttt{ncar} (Bae
\protect\hyperlink{ref-R-ncar}{2017}), \texttt{pkr} (Bae and Lee
\protect\hyperlink{ref-R-pkr}{2017}) 은 비구획 분석을 R을 통해 쉽고
빠르게 (매우 빠르게) 행할 수 있는 R 패키지입니다.
...
\texttt{NonCompart} (Bae \protect\hyperlink{ref-R-NonCompart}{2018})은
...
\NormalTok{                       Package version }\DecValTok{0}\NormalTok{.}\FloatTok{3.7}\NormalTok{ (}\DecValTok{2017-08-16}\NormalTok{ KST)}
\NormalTok{                          R version }\DecValTok{3}\NormalTok{.}\FloatTok{4.4}\NormalTok{ (}\DecValTok{2018-03-15}\NormalTok{)}

\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2018-03-16} \DecValTok{14}\OperatorTok{:}\DecValTok{59}\OperatorTok{:}\DecValTok{43}\NormalTok{ KST}
...
##  NonCompart  * 0.4.0      2018-03-15 CRAN (R 3.4.3)                      
...
Bae, Kyun-Seop. 2017. \emph{Ncar: Noncompartmental Analysis for
Pharmacokinetic Report}. \url{https://CRAN.R-project.org/package=ncar}.

\leavevmode\hypertarget{ref-R-NonCompart}{}%
---------. 2018. \emph{NonCompart: Noncompartmental Analysis for
