...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2017}\OperatorTok{-}\DecValTok{11}\OperatorTok{-}\DecValTok{15} \DecValTok{16}\OperatorTok{:}\DecValTok{51}\OperatorTok{:}\DecValTok{38}\NormalTok{ KST}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(PPTESTCD }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'CMAX'}\NormalTok{, }\StringTok{'TMAX'}\NormalTok{, }\StringTok{'AUCLST'}\NormalTok{, }\StringTok{'AUCIFO'}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2017}\OperatorTok{-}\DecValTok{11}\OperatorTok{-}\DecValTok{15} \DecValTok{16}\OperatorTok{:}\DecValTok{51}\OperatorTok{:}\DecValTok{39}\NormalTok{ KST}
