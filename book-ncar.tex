...
\texttt{tidyverse}({\textbf{???}})를 설치하면 다수의 편리한 패키지
\texttt{tidyr} ({\textbf{???}}), \texttt{dplyr} ({\textbf{???}}),
\texttt{tibble} ({\textbf{???}}), \texttt{ggplot2} {[}R-ggplot2{]},
\texttt{purrr} ({\textbf{???}}), \texttt{readr} ({\textbf{???}})의
설치와 불러오기 과정을 쉽게 끝낼 수 있습니다.
...
\NormalTok{                          R version }\DecValTok{3}\NormalTok{.}\FloatTok{4.2}\NormalTok{ (}\DecValTok{2017-09-28}\NormalTok{)}

\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2017-11-15} \DecValTok{11}\OperatorTok{:}\DecValTok{19}\OperatorTok{:}\DecValTok{32}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
...
\begin{figure}
\centering
\includegraphics{assets/twobytwo.jpg}
\caption{\label{fig:twobytwo}전형적인 2x2 설계}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/fixed-random.jpg}
\caption{\label{fig:fixedrandom}모수 인자와 변량 인자의 비교}
\end{figure}
...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2017-11-15} \DecValTok{11}\OperatorTok{:}\DecValTok{19}\OperatorTok{:}\DecValTok{33}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
