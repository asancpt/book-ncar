...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2018-08-10} \DecValTok{18}\OperatorTok{:}\DecValTok{14}\OperatorTok{:}\DecValTok{07}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
...
생물학적 동등성을 위한 가장 간단한 방법은 \texttt{BE}
패키지({\textbf{???}})를 쓰는 것입니다.
...
\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2018-08-10} \DecValTok{18}\OperatorTok{:}\DecValTok{14}\OperatorTok{:}\DecValTok{08}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
