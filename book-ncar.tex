...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tblNCA}\NormalTok{(concData, }\DataTypeTok{key =} \StringTok{"Subject"}\NormalTok{, }\DataTypeTok{colTime =} \StringTok{"Time"}\NormalTok{, }\DataTypeTok{colConc =} \StringTok{"conc"}\NormalTok{, }\DataTypeTok{dose =} \DecValTok{0}\NormalTok{, }
       ...
       \DataTypeTok{concUnit =} \StringTok{"ug/L"}\NormalTok{, }\DataTypeTok{down =} \StringTok{"Linear"}\NormalTok{, }\DataTypeTok{R2ADJ =} \FloatTok{0.7}\NormalTok{, }\DataTypeTok{MW =} \DecValTok{0}\NormalTok{) }\CommentTok{# args(NonCompart::tblNCA)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
##      Subject         b0 CMAX  CMAXD TMAX TLAG CLST      CLSTP TLST
## [1,]       1 -1.7242106 1.50 0.0600 0.25   NA 0.05 0.05024851    8
## [2,]       3 -0.1752869 2.03 0.0812 0.25   NA 0.08 0.07475591    8
## [3,]       6         NA 2.72 0.1088 0.25   NA 0.08         NA    8
## [4,]       2         NA 1.85 0.0740 0.25   NA 0.07         NA    8
## [5,]       4         NA 2.05 0.0820 0.25   NA 0.06         NA    8
## [6,]       5         NA 2.31 0.0924 0.25   NA 0.09         NA    8
##        LAMZHL      LAMZ LAMZLL LAMZUL LAMZNPT     CORRXY        R2
## [1,] 4.378127 0.1583205   5.00      8       3 -0.9985323 0.9970667
## [2,] 2.293063 0.3022800   0.75      8       9 -0.9734830 0.9476691
## [3,]       NA        NA     NA     NA       0         NA        NA
## [4,]       NA        NA     NA     NA       0         NA        NA
## [5,]       NA        NA     NA     NA       0         NA        NA
## [6,]       NA        NA     NA     NA       0         NA        NA
##          R2ADJ   AUCLST   AUCALL   AUCIFO    AUCIFOD   AUCIFP    AUCIFPD
## [1,] 0.9941335 2.040452 2.040452 2.356267 0.09425069 2.357837 0.09431348
## [2,] 0.9401933 3.248520 3.248520 3.513175 0.14052701 3.495827 0.13983307
## [3,]        NA 3.554421 3.554421       NA         NA       NA         NA
## [4,]        NA 2.785279 2.785279       NA         NA       NA         NA
## [5,]        NA 2.458858 2.458858       NA         NA       NA         NA
## [6,]        NA 3.335703 3.335703       NA         NA       NA         NA
##         AUCPEO    AUCPEP  AUMCLST  AUMCIFO  AUMCIFP  AUMCPEO  AUMCPEP
## [1,] 13.403196 13.460844 3.271250 7.792554 7.815026 58.02083 58.14153
## [2,]  7.533221  7.074344 6.398750 9.391522 9.195343 31.86674 30.41314
## [3,]        NA        NA 5.006250       NA       NA       NA       NA
## [4,]        NA        NA 4.381875       NA       NA       NA       NA
## [5,]        NA        NA 3.707500       NA       NA       NA       NA
## [6,]        NA        NA 5.532500       NA       NA       NA       NA
##            C0  AUCPBEO  AUCPBEP      VZO      VZP      CLO       CLP
## [1,] 2.393617 20.65564 20.64189 67.01598 66.97136 10.61000 10.602939
## [2,] 2.528160 16.21809 16.29857 23.54132 23.65814  7.11607  7.151384
## [3,] 4.965369       NA       NA       NA       NA       NA        NA
## [4,] 2.462230       NA       NA       NA       NA       NA        NA
## [5,] 4.040865       NA       NA       NA       NA       NA        NA
## [6,] 3.705625       NA       NA       NA       NA       NA        NA
##      MRTIVLST MRTIVIFO MRTIVIFP     VSSO     VSSP
## [1,] 1.353199 3.057161 3.064490 32.43648 32.49260
## [2,] 1.719743 2.423229 2.380377 17.24387 17.02299
## [3,] 1.158457       NA       NA       NA       NA
## [4,] 1.323227       NA       NA       NA       NA
## [5,] 1.257814       NA       NA       NA       NA
## [6,] 1.408571       NA       NA       NA       NA
## attr(,"units")
##  [1] ""          ""          "mg/L"      "mg/L/mg"   "h"        
##  [6] "h"         "mg/L"      "mg/L"      "h"         "h"        
## [11] "/h"        "h"         "h"         ""          ""         
...
\begin{verbatim}
##  num [1:12, 1:37] 11 6 5 7 12 1 2 3 8 10 ...
...
##      <dbl> <chr>       <dbl> <chr>    
##  1       1 AUCALL    73.8    h*mg/L   
##  2       1 AUCIFO    84.3    h*mg/L   
##  3       1 AUCIFOD    0.263  h*mg/L/mg
##  4       1 AUCIFP    84.5    h*mg/L   
##  5       1 AUCIFPD    0.264  h*mg/L/mg
##  6       1 AUCLST    73.8    h*mg/L   
##  7       1 AUCPEO    12.4    %        
##  8       1 AUCPEP    12.7    %        
##  9       1 AUMCIFO  978.     h2*mg/L  
## 10       1 AUMCIFP  987.     h2*mg/L  
## 11       1 AUMCLST  609.     h2*mg/L  
## 12       1 AUMCPEO   37.7    %        
## 13       1 AUMCPEP   38.3    %        
## 14       1 b0         2.03   ""       
## 15       1 CLFO       3.80   L/h      
## 16       1 CLFP       3.79   L/h      
## 17       1 CLST       0.92   mg/L     
## 18       1 CLSTP      0.941  mg/L     
## 19       1 CMAX       6.44   mg/L     
## 20       1 CMAXD      0.0201 mg/L/mg
\end{verbatim}
...
\NormalTok{                       Package version }\DecValTok{0}\NormalTok{.}\FloatTok{1.2}\NormalTok{ (}\DecValTok{2018-06-04}\NormalTok{)}
\NormalTok{                          R version }\DecValTok{3}\NormalTok{.}\FloatTok{5.1}\NormalTok{ (}\DecValTok{2018-07-02}\NormalTok{)}

\NormalTok{Date and Time}\OperatorTok{:}\StringTok{ }\DecValTok{2018-07-04} \DecValTok{08}\OperatorTok{:}\DecValTok{56}\OperatorTok{:}\DecValTok{38}\NormalTok{ Asia}\OperatorTok{/}\NormalTok{Seoul}
...
\begin{figure}
\includegraphics[width=1\linewidth]{Output/Individual_PK_Linear_Scale_for_Theoph00} \caption{약동학 파라메터와 함께 표시되는 농도-시간 그림 (선형)}\label{fig:unnamed-chunk-36}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{Output/Individual_PK_Log_10_Scale_for_Theoph00} \caption{약동학 파라메터와 함께 표시되는 농도-시간 그림 (로그)}\label{fig:unnamed-chunk-37}
\end{figure}
...
\begin{verbatim}
## Error in `[.data.frame`(concData, concData$SUBJ == 1 & concData$GRP == : 객체 'RT'를 찾을 수 없습니다
\end{verbatim}
...
\caption{\label{tab:unnamed-chunk-52}Description of settings for the
...
##  ncar        * 0.4.1   2018-06-20 CRAN (R 3.5.0)                     
##  ncarbe      * 0.1.0   2017-12-05 local                              
##  nlme          3.1-137 2018-04-07 CRAN (R 3.5.1)                     
##  NonCompart  * 0.4.3   2018-06-20 CRAN (R 3.5.0)                     
...
##  xfun          0.2     2018-06-16 CRAN (R 3.5.0)                     
...
\leavevmode\hypertarget{ref-R-ncarbe}{}%
