...
```
## Error in ncappc(obsFile = "Theoph_ncappc.csv", onlyNCA = TRUE, extrapolate = TRUE, : unused arguments (onlyNCA = TRUE, extrapolate = TRUE)
```
...
```
## Error in eval(expr, envir, enclos): object 'Theoph_ncappc_results' not found
```
