...
Table: (\#tab:wide)Entire PK parameters calculated by NonCompart
...
Table: (\#tab:pkparam)Selected PK parameters including iAUC
...
<p class="caption">(\#fig:ggfig)Individual concentration-time curves</p>
</div>
...
Table: (\#tab:sdoral)Selected PK parameters including iAUC of sd oral richpk
...
Table: (\#tab:descstat-iauc)Descriptive statistics of selected PK parameters of Theoph
...
Table: (\#tab:unnamed-chunk-2)Descriptive statistics of selected PK parameters manually calculated.
